...
3. 读取 [`../DDNet-QmClient-客户端质量扫描提示词.md`](../DDNet-QmClient-客户端质量扫描提示词.md) 的以下内容：
   ...
   - 提交或发布审计时，额外读取第 5 节。
4. 代码修改读取 [`../../../ai-workflow/ddnet-development.md`](../../../ai-workflow/ddnet-development.md)；审查读取 [`../../../ai-workflow/review.md`](../../../ai-workflow/review.md)；验证读取 [`../../../ai-workflow/verification.md`](../../../ai-workflow/verification.md)。
...
| 触发风险 | 必读规则 |
| --- | --- |
| 新功能、新配置、用户可见行为 | [`../../../ai-workflow/advanced/feature-introduction.md`](../../../ai-workflow/advanced/feature-introduction.md) |
| 卡顿、长帧、页面降温、性能优化 | [`../../../ai-workflow/advanced/performance-workflow.md`](../../../ai-workflow/advanced/performance-workflow.md) |
| telemetry、perf 日志或报表系统本身 | [`../../../ai-workflow/advanced/perf-system-workflow.md`](../../../ai-workflow/advanced/perf-system-workflow.md) |
| 缓存、纹理、指针、UI element、异步结果 | [`../../../ai-workflow/advanced/memory-lifetime.md`](../../../ai-workflow/advanced/memory-lifetime.md) |
| 后台任务、取消、队列、主线程发布、GPU context | [`../../../ai-workflow/advanced/threading-jobs.md`](../../../ai-workflow/advanced/threading-jobs.md) |
| debug 面板、日志、debug bundle、复现证据 | [`../../../ai-workflow/advanced/observability-debugging.md`](../../../ai-workflow/advanced/observability-debugging.md) |
| 文件、下载、解压、外部输入、隐私和脱敏 | [`../../../ai-workflow/advanced/safety-security.md`](../../../ai-workflow/advanced/safety-security.md) |
| 行为保持型结构调整 | [`../../../ai-workflow/advanced/refactor-workflow.md`](../../../ai-workflow/advanced/refactor-workflow.md) |
| bug 回归、固定场景、A/B、release checklist | [`../../../ai-workflow/advanced/regression-prevention.md`](../../../ai-workflow/advanced/regression-prevention.md) |
