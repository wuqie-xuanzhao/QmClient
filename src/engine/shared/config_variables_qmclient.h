...
MACRO_CONFIG_INT(QmCardBackdropBlur, qm_card_backdrop_blur, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Card frosted glass background blur (0=Off, 1=On; recommended for high-performance PCs only)")
...
MACRO_CONFIG_COL(QmUiColor, qm_ui_color, 0x000000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Interface color")
MACRO_CONFIG_COL(QmUiFocusColor, qm_ui_focus_color, 0x97FFA6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Input focus color")
MACRO_CONFIG_COL(QmMapBrowserColor, qm_map_browser_color, 0x000000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Map browser color")
MACRO_CONFIG_COL(QmScoreboardColor, qm_scoreboard_color, 0x000000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Scoreboard color")
...
MACRO_CONFIG_INT(QmInputOverlayScale, qm_input_overlay_scale, 20, 1, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Input overlay scale (percent)")
...
MACRO_CONFIG_STR(QmFriendEnterBroadcastText, qm_friend_enter_broadcast_text, 128, "%s好友进入本服", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Large text for friend join (use %s for friend name)")
MACRO_CONFIG_STR(QmFriendEnterGreetText, qm_friend_enter_greet_text, 128, "你好啊!", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto greet friend text")
...
MACRO_CONFIG_INT(QmSmtcLyricsEnable, qm_smtc_lyrics_enable, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable system media lyrics")
MACRO_CONFIG_INT(QmSmtcLyricsOffsetMs, qm_smtc_lyrics_offset_ms, 0, -10000, 10000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "System media lyrics time offset (milliseconds)")
MACRO_CONFIG_INT(QmSmtcLyricsLines, qm_smtc_lyrics_lines, 2, 1, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "System media lyrics display lines")
MACRO_CONFIG_INT(QmSmtcLyricsFontSize, qm_smtc_lyrics_font_size, 6, 4, 16, CFGFLAG_CLIENT | CFGFLAG_SAVE, "System media lyric font size")
MACRO_CONFIG_COL(QmLyricsColor, qm_lyrics_color, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Current line lyric color")
MACRO_CONFIG_COL(QmLyricsNextColor, qm_lyrics_next_color, 0x88FFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Next line lyric color")
MACRO_CONFIG_COL(QmLyricsBgColor, qm_lyrics_bg_color, 0xFF000000, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Lyric background color")
MACRO_CONFIG_INT(QmLyricsBgOpacity, qm_lyrics_bg_opacity, 38, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric background opacity")
MACRO_CONFIG_COL(QmLyricsOutlineColor, qm_lyrics_outline_color, 0xFF000000, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Lyric outline color")
MACRO_CONFIG_INT(QmLyricsOutlineOpacity, qm_lyrics_outline_opacity, 45, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric outline opacity")
MACRO_CONFIG_INT(QmLyricsMarquee, qm_lyrics_marquee, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Marquee for long lyrics")
MACRO_CONFIG_INT(QmLyricsMarqueeSpeed, qm_lyrics_marquee_speed, 35, 5, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Marquee speed")
MACRO_CONFIG_INT(QmLyricsAutoHideNoSmtc, qm_lyrics_auto_hide_no_smtc, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hide lyrics when no system media")
MACRO_CONFIG_INT(QmLyricsFadeDurationMs, qm_lyrics_fade_duration_ms, 180, 0, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric fade in/out time")
MACRO_CONFIG_INT(QmLyricsSnapThreshold, qm_lyrics_snap_threshold, 8, 0, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric snap to Dynamic Island threshold")

// Lyrics HUD (CQmLyrics 重写版) - 歌词叠加层
MACRO_CONFIG_INT(QmLyrics, qm_lyrics, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable lyric HUD overlay")
MACRO_CONFIG_INT(QmLyricsInMediaIsland, qm_lyrics_in_media_island, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lyrics inside Dynamic Island")
MACRO_CONFIG_INT(QmLyricsSource, qm_lyrics_source, 0, 0, 10, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric source (0=Auto best match, 1=LRCLIB, 2=Kugou, 3=QQ, 4=Netease, 5=AMLL TTML DB, 6=Apple Music, 7=Local Music File, 8=Local LRC, 9=Local ESLRC, 10=Local TTML)")
MACRO_CONFIG_INT(QmLyricsSearchType, qm_lyrics_search_type, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric search strategy (0=Sequential by source, 1=Concurrent best match)")
MACRO_CONFIG_STR(QmLyricsSourceOrder, qm_lyrics_source_order, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric auto search source order/enable list (empty=default; use | separator, e.g. QQ|Kugou|Netease|LrcLib)")
MACRO_CONFIG_STR(QmLyricsProviderThresholds, qm_lyrics_provider_thresholds, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric source specific match threshold (empty=global threshold; e.g. QQ=60|LrcLib=70)")
MACRO_CONFIG_STR(QmLyricsIgnoreCacheProviders, qm_lyrics_ignore_cache_providers, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Ignore cached sources when searching lyrics (use | separator, e.g. QQ|Kugou)")
MACRO_CONFIG_INT(QmLyricsAutoFetch, qm_lyrics_auto_fetch, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto-fetch lyrics on detecting new song")
MACRO_CONFIG_INT(QmLyricsCacheEnable, qm_lyrics_cache_enable, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable local lyrics cache")
MACRO_CONFIG_INT(QmLyricsCacheTtlDays, qm_lyrics_cache_ttl_days, 30, 0, 3650, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics cache expiration days (0=forever)")
MACRO_CONFIG_INT(QmLyricsMatchThreshold, qm_lyrics_match_threshold, 60, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics fuzzy match score threshold")
MACRO_CONFIG_INT(QmLyricsLinesAbove, qm_lyrics_lines_above, 2, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lines above active line")
MACRO_CONFIG_INT(QmLyricsLinesBelow, qm_lyrics_lines_below, 3, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lines below active line")
MACRO_CONFIG_INT(QmLyricsFontSize, qm_lyrics_font_size, 18, 8, 48, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Active line font size (px)")
MACRO_CONFIG_INT(QmLyricsFontSizeOther, qm_lyrics_font_size_other, 14, 6, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Inactive line font size (px)")
MACRO_CONFIG_INT(QmLyricsLineSpacing, qm_lyrics_line_spacing, 6, 0, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics line spacing (px)")
MACRO_CONFIG_INT(QmLyricsOpacity, qm_lyrics_opacity, 90, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Overall lyrics opacity (%)")
MACRO_CONFIG_INT(QmLyricsInactiveOpacity, qm_lyrics_inactive_opacity, 35, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Minimum inactive line opacity (%)")
MACRO_CONFIG_COL(QmLyricsColorPlayed, qm_lyrics_color_played, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Played word color")
MACRO_CONFIG_COL(QmLyricsColorUnplayed, qm_lyrics_color_unplayed, 0xFFCCCCCC, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Unplayed word color")
MACRO_CONFIG_COL(QmLyricsColorTranslation, qm_lyrics_color_translation, 0xFF888888, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Lyrics translation/transliteration color")
MACRO_CONFIG_INT(QmLyricsShowTranslation, qm_lyrics_show_translation, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lyrics translation (if available)")
MACRO_CONFIG_INT(QmLyricsShowTransliteration, qm_lyrics_show_transliteration, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lyrics transliteration (if available)")
MACRO_CONFIG_INT(QmLyricsKaraoke, qm_lyrics_karaoke, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable word-by-word highlighting")
MACRO_CONFIG_INT(QmLyricsHighlightEdgeSoft, qm_lyrics_highlight_edge_soft, 8, 0, 32, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Word highlight soft edge width (px)")
MACRO_CONFIG_INT(QmLyricsScaleActive, qm_lyrics_scale_active, 106, 100, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Active line scale (%)")
MACRO_CONFIG_INT(QmLyricsScaleFalloff, qm_lyrics_scale_falloff, 4, 0, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Distant line shrink per line (%)")
MACRO_CONFIG_INT(QmLyricsFadePerLine, qm_lyrics_fade_per_line, 18, 0, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Distant line opacity decay per line (%)")
MACRO_CONFIG_INT(QmLyricsScrollMs, qm_lyrics_scroll_ms, 350, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Line switch scroll duration (ms)")
MACRO_CONFIG_INT(QmLyricsDriftCorrectMs, qm_lyrics_drift_correct_ms, 1000, 100, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Clock drift hard cut threshold (ms)")
MACRO_CONFIG_INT(QmLyricsEdgeMargin, qm_lyrics_edge_margin, 8, 0, 64, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric HUD edge margin (px)")
MACRO_CONFIG_INT(QmLyricsHttpTimeoutMs, qm_lyrics_http_timeout_ms, 8000, 500, 30000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric HTTP request timeout (ms)")
MACRO_CONFIG_STR(QmLyricsLrclibBase, qm_lyrics_lrclib_base, 64, "https://lrclib.net", CFGFLAG_CLIENT | CFGFLAG_SAVE, "LRCLIB API base URL (mirror)")
MACRO_CONFIG_STR(QmLyricsAmllTtmlDbBase, qm_lyrics_amll_ttml_db_base, 128, "https://raw.githubusercontent.com/amll-dev/amll-ttml-db/refs/heads/main", CFGFLAG_CLIENT | CFGFLAG_SAVE, "AMLL TTML DB API base URL (mirror)")
...
MACRO_CONFIG_STR(QmLyricsLocalMediaFolders, qm_lyrics_local_media_folders, 4096, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Local media library directories (separate by |)")
MACRO_CONFIG_STR(QmLyricsHttpProxy, qm_lyrics_http_proxy, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric HTTP proxy (e.g. http://127.0.0.1:7890)")
MACRO_CONFIG_INT(QmLyricsOffsetMs, qm_lyrics_offset_ms, 0, -30000, 30000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Manual lyric timeline offset (ms, step 500ms)")
MACRO_CONFIG_INT(QmLyricsHideWhenPaused, qm_lyrics_hide_when_paused, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hide lyrics on pause")
MACRO_CONFIG_INT(QmLyricsHideNoLyrics, qm_lyrics_hide_no_lyrics, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Hide when no lyrics found (instead of showing hint)")
...
MACRO_CONFIG_COL(QmTranslateBtnColorDisabled, qm_translate_btn_color_disabled, 0xD1000029, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translation button cancel color")
MACRO_CONFIG_COL(QmTranslateBtnColorEnabled, qm_translate_btn_color_enabled, 0xE69E5E86, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translation button active color")
MACRO_CONFIG_COL(QmTranslateMenuBgColor, qm_translate_menu_bg_color, 0xF200001F, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translation menu background color")
MACRO_CONFIG_COL(QmTranslateMenuOptionSelected, qm_translate_menu_option_selected, 0xE69E5E86, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translation menu selected color")
MACRO_CONFIG_COL(QmTranslateMenuOptionNormal, qm_translate_menu_option_normal, 0xE6000033, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Translation menu normal color")
