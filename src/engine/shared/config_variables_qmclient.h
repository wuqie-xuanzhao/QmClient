...
MACRO_CONFIG_INT(QmNameplateTextEffects, qm_nameplate_text_effects, 1, 0, 15, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Nameplate text effects (1=Border 2=Gradient 4=Rainbow 8=Light halo)")
...
MACRO_CONFIG_COL(QmNameplateTextGlowColor, qm_nameplate_text_glow_color, 0x664CC6FF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Nameplate text light halo color")
MACRO_CONFIG_INT(QmNameplateTextGlowRange, qm_nameplate_text_glow_range, 0, 0, 12, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Nameplate text light halo range")
...
MACRO_CONFIG_INT(QmSkinQueueInterval, qm_skin_queue_interval, 600, 1, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE, "皮肤队列切换间隔（毫秒）")
...
MACRO_CONFIG_INT(QmDummySkinQueueInterval, qm_dummy_skin_queue_interval, 600, 1, 0, CFGFLAG_CLIENT | CFGFLAG_SAVE, "分身皮肤队列切换间隔（毫秒）")
...
MACRO_CONFIG_INT(QmLyrics, qm_lyrics, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable lyrics HUD overlay")
MACRO_CONFIG_INT(QmLyricsSource, qm_lyrics_source, 0, 0, 10, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics source (0=Auto best match, 1=LRCLIB, 2=Kugou, 3=QQ, 4=Netease, 5=AMLL TTML DB, 6=Apple Music, 7=Local Music File, 8=Local LRC, 9=Local ESLRC, 10=Local TTML)")
MACRO_CONFIG_INT(QmLyricsSearchType, qm_lyrics_search_type, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics search strategy (0=source order, 1=parallel best match)")
MACRO_CONFIG_STR(QmLyricsSourceOrder, qm_lyrics_source_order, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics auto-search source order and enable list (empty=default; use | as separator, e.g. QQ|Kugou|Netease|LrcLib)")
MACRO_CONFIG_STR(QmLyricsProviderThresholds, qm_lyrics_provider_thresholds, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics per-source match thresholds (empty=global threshold; e.g. QQ=60|LrcLib=70)")
MACRO_CONFIG_STR(QmLyricsIgnoreCacheProviders, qm_lyrics_ignore_cache_providers, 512, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics sources that ignore cache during search (use | as separator, e.g. QQ|Kugou)")
MACRO_CONFIG_INT(QmLyricsAutoFetch, qm_lyrics_auto_fetch, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto fetch lyrics online when a new song is detected")
MACRO_CONFIG_INT(QmLyricsCacheEnable, qm_lyrics_cache_enable, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable local lyrics cache")
MACRO_CONFIG_INT(QmLyricsCacheTtlDays, qm_lyrics_cache_ttl_days, 30, 0, 3650, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics cache expiry days (0=never expire)")
...
MACRO_CONFIG_INT(QmLyricsLinesAbove, qm_lyrics_lines_above, 2, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics lines shown above active line")
MACRO_CONFIG_INT(QmLyricsLinesBelow, qm_lyrics_lines_below, 3, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics lines shown below active line")
MACRO_CONFIG_INT(QmLyricsFontSize, qm_lyrics_font_size, 18, 8, 48, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Active lyrics line font size in px")
MACRO_CONFIG_INT(QmLyricsFontSizeOther, qm_lyrics_font_size_other, 14, 6, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Inactive lyrics line font size in px")
MACRO_CONFIG_INT(QmLyricsLineSpacing, qm_lyrics_line_spacing, 6, 0, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics line spacing in px")
MACRO_CONFIG_INT(QmLyricsOpacity, qm_lyrics_opacity, 90, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics overall opacity percent")
MACRO_CONFIG_INT(QmLyricsInactiveOpacity, qm_lyrics_inactive_opacity, 35, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Inactive lyrics line minimum opacity percent")
MACRO_CONFIG_COL(QmLyricsColorPlayed, qm_lyrics_color_played, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Played lyrics word color")
MACRO_CONFIG_COL(QmLyricsColorUnplayed, qm_lyrics_color_unplayed, 0xFFCCCCCC, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Unplayed lyrics word color")
MACRO_CONFIG_COL(QmLyricsColorTranslation, qm_lyrics_color_translation, 0xFF888888, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "Lyrics translation and transliteration color")
MACRO_CONFIG_INT(QmLyricsShowTranslation, qm_lyrics_show_translation, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lyrics translation when available")
MACRO_CONFIG_INT(QmLyricsShowTransliteration, qm_lyrics_show_transliteration, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show lyrics transliteration when available")
MACRO_CONFIG_INT(QmLyricsKaraoke, qm_lyrics_karaoke, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable karaoke word highlighting")
MACRO_CONFIG_INT(QmLyricsHighlightEdgeSoft, qm_lyrics_highlight_edge_soft, 8, 0, 32, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Karaoke highlight soft edge width in px")
MACRO_CONFIG_INT(QmLyricsScaleActive, qm_lyrics_scale_active, 106, 100, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Active lyrics line scale percent")
MACRO_CONFIG_INT(QmLyricsScaleFalloff, qm_lyrics_scale_falloff, 4, 0, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics scale shrink percent per distance line")
MACRO_CONFIG_INT(QmLyricsFadePerLine, qm_lyrics_fade_per_line, 18, 0, 40, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics opacity fade percent per distance line")
MACRO_CONFIG_INT(QmLyricsScrollMs, qm_lyrics_scroll_ms, 350, 0, 1000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics line switch scroll duration in ms")
MACRO_CONFIG_INT(QmLyricsDriftCorrectMs, qm_lyrics_drift_correct_ms, 1000, 100, 5000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics clock drift hard snap threshold in ms")
MACRO_CONFIG_INT(QmLyricsEdgeMargin, qm_lyrics_edge_margin, 8, 0, 64, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics HUD edge margin in px")
MACRO_CONFIG_INT(QmLyricsHttpTimeoutMs, qm_lyrics_http_timeout_ms, 8000, 500, 30000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyrics HTTP request timeout in ms")
MACRO_CONFIG_STR(QmLyricsLrclibBase, qm_lyrics_lrclib_base, 64, "https://lrclib.net", CFGFLAG_CLIENT | CFGFLAG_SAVE, "LRCLIB API base URL (can be changed to a mirror)")
MACRO_CONFIG_STR(QmLyricsAmllTtmlDbBase, qm_lyrics_amll_ttml_db_base, 128, "https://raw.githubusercontent.com/amll-dev/amll-ttml-db/refs/heads/main", CFGFLAG_CLIENT | CFGFLAG_SAVE, "AMLL TTML DB API base URL (can be changed to a mirror)")
