...
MACRO_CONFIG_INT(QmUiIconColor, qm_ui_icon_color, 1, 1, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Qm UI icon color: 1=White, 2=Black")
MACRO_CONFIG_INT(QmUiIconWeight, qm_ui_icon_weight, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Qm UI icon weight: 0=Regular, 1=Bold")
...
MACRO_CONFIG_INT(QmCardLayoutVersion, qm_card_layout_version, 0, 0, 6, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Settings card default layout migration version")
...
MACRO_CONFIG_INT(QmLyricsSearchType, qm_lyrics_search_type, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Lyric search strategy (0=Sequential by source, 1=Concurrent best match)")
...
MACRO_CONFIG_INT(QmLyricsCacheEnable, qm_lyrics_cache_enable, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable local lyrics cache")
