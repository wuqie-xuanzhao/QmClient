...
MACRO_CONFIG_INT(QmUiCardRainbowTitles, qm_ui_card_rainbow_titles, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "设置卡片标题使用彩虹色")
...
MACRO_CONFIG_INT(QmCardLayoutVersion, qm_card_layout_version, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "设置卡片默认布局迁移版本")
