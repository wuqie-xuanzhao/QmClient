...
MACRO_CONFIG_COL(QmUiColor, qm_ui_color, 0xE4A046, CFGFLAG_CLIENT | CFGFLAG_SAVE, "界面颜色")
MACRO_CONFIG_COL(QmMapBrowserColor, qm_map_browser_color, 0x242D1F, CFGFLAG_CLIENT | CFGFLAG_SAVE, "地图浏览器颜色")
MACRO_CONFIG_COL(QmScoreboardColor, qm_scoreboard_color, 0xE4A046, CFGFLAG_CLIENT | CFGFLAG_SAVE, "计分板颜色")
MACRO_CONFIG_INT(QmUiOpacity, qm_ui_opacity, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "通用界面透明度")
MACRO_CONFIG_INT(QmMapBrowserOpacity, qm_map_browser_opacity, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "地图浏览器透明度")
MACRO_CONFIG_INT(QmScoreboardOpacity, qm_scoreboard_opacity, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "计分板透明度")
...
MACRO_CONFIG_INT(QmLyricsEnlargeFirstChar, qm_lyrics_enlarge_first_char, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "歌词首字放大")
MACRO_CONFIG_INT(QmLyricsFirstCharScale, qm_lyrics_first_char_scale, 125, 100, 180, CFGFLAG_CLIENT | CFGFLAG_SAVE, "歌词首字缩放百分比")
MACRO_CONFIG_COL(QmLyricsFirstCharColor, qm_lyrics_first_char_color, 0xFFFFFFFF, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "歌词首字颜色")
MACRO_CONFIG_INT(QmLyricsShowIndicator, qm_lyrics_show_indicator, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "显示歌词当前行指示器")
MACRO_CONFIG_COL(QmLyricsIndicatorColor, qm_lyrics_indicator_color, 0xFFFFD45A, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLALPHA, "歌词指示器颜色")
