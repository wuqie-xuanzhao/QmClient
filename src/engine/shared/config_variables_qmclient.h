...
MACRO_CONFIG_INT(QmGraphicsMode, qm_graphics_mode, 0, -1, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Graphics mode: -1=use backend setting, 0=compatibility, 1=performance (iOS compatibility default until iOS adaptation is complete)")
#else
