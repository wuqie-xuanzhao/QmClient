...
bool qm_update_apply(const char *pPackagePath, const char *pPackageSignaturePath, const char *pManifestPath, const char *pManifestSignaturePath, const char *pInstallPath, char *pError, size_t ErrorSize);
}
