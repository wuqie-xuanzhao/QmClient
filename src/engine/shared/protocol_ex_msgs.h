...
UUID(NETMSG_QM_DEMO_HUD_STATE, "demo-hud-state@qmclient")
UUID(NETMSG_QM_DEMO_INPUT_STATE, "demo-input-state@qmclient")
UUID(NETMSG_QM_DEMO_INPUT_WHEEL, "demo-input-wheel@qmclient")
UUID(NETMSG_QM_LIVE_OBSERVER_REQUEST, "live-observer-request@qmclient/v1")
UUID(NETMSG_QM_LIVE_OBSERVER_ACCEPT, "live-observer-accept@qmclient/v1")
UUID(NETMSG_QM_LIVE_OBSERVER_DENY, "live-observer-deny@qmclient/v1")
UUID(NETMSG_KCP_CAPABLE, "kcp-capable@qmclient")
UUID(NETMSG_KCP_ACCEPT, "kcp-accept@qmclient")
UUID(NETMSG_KCP_FALLBACK, "kcp-fallback@qmclient")
UUID(NETMSG_CLIENT_BRANDS, "client-brands@arghena-qm/v2")
