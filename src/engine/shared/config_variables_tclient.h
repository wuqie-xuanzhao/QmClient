...
MACRO_CONFIG_INT(TcJumpHintLegacy, tc_jump_hint, 0, 0, 1, CFGFLAG_CLIENT, "已废弃：跳跃提示开关，启动时迁移到 qm_jump_hint")
MACRO_CONFIG_STR(TcJumpHintTextLegacy, tc_jump_hint_text, 512, "", CFGFLAG_CLIENT, "已废弃：跳跃提示文本，启动时迁移到 qm_jump_hint_text（使用\\n换行）")
MACRO_CONFIG_COL(TcJumpHintColorLegacy, tc_jump_hint_color, 255, CFGFLAG_CLIENT, "已废弃：跳跃提示颜色，启动时迁移到 qm_jump_hint_color")
MACRO_CONFIG_INT(TcJumpHintXLegacy, tc_jump_hint_x, 20, 0, 100, CFGFLAG_CLIENT, "已废弃：跳跃提示水平位置，启动时迁移到 qm_jump_hint_x")
MACRO_CONFIG_INT(TcJumpHintYLegacy, tc_jump_hint_y, 5, 0, 100, CFGFLAG_CLIENT, "已废弃：跳跃提示垂直位置，启动时迁移到 qm_jump_hint_y")
MACRO_CONFIG_INT(TcJumpHintSizeLegacy, tc_jump_hint_size, 10, 0, 50, CFGFLAG_CLIENT, "已废弃：跳跃提示字体大小，启动时迁移到 qm_jump_hint_size")
...
// Voting
MACRO_CONFIG_INT(TcAutoVoteWhenFar, tc_auto_vote_when_far, 0, 0, 2, CFGFLAG_CLIENT | CFGFLAG_SAVE, "达到最小时长后自动处理换图投票（0=关闭，1=反对，2=同意）")
MACRO_CONFIG_STR(TcAutoVoteWhenFarMessage, tc_auto_vote_when_far_message, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "自动投票时发送的消息，留空则不发送")
MACRO_CONFIG_INT(TcAutoVoteWhenFarTime, tc_auto_vote_when_far_time, 5, 0, 20, CFGFLAG_CLIENT | CFGFLAG_SAVE, "触发自动投票前的等待时间")
