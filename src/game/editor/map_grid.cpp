...
CUi::EPopupMenuFunctionResult CMapGrid::PopupGridSettings(void *pContext, CUIRect View, bool Active)
{
	...
	CProperty aProps[] = {
		{Localize("Size", "Editor"), pMapGrid->Factor(), PROPTYPE_INT, MIN_GRID_FACTOR, MAX_GRID_FACTOR},
		{nullptr},
	};
	...
	if(pMapGrid->Editor()->DoButton_Ex(&s_DefaultButton, Localize("Default", "Editor"), 0, &Button, BUTTONFLAG_LEFT, Localize("Reset to normal grid size.", "Editor"), IGraphics::CORNER_ALL))
	{
