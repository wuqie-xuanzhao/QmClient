...
namespace QmLyrics
{
	...
	// 构造 LRCLIB 搜索 URL：https://lrclib.net/api/search?track_name=...&artist_name=...&album_name=...&durationMs=...
	...
	{
	public:
		CLyricsSourceLrclib(IHttp *pHttp, int TimeoutMs = 8000, const char *pBaseUrl = "https://lrclib.net");
