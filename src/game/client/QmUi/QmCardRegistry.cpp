...
namespace qm_card_registry
{
	...
	static const std::vector<SCardDefault> &DefaultsTable()
	{
		...
		static const std::vector<SCardDefault> s_aDefaults = {
			...
			{"qm:lyrics", "hud", ECardColumn::Right, 16, "Lyrics", "歌词 geci lyrics 来源 laiyuan source 网易云 wangyi netease 汽水 qishui soda 显示 xianshi 灵动岛 lingdongdao hud", "Lyrics sources and display"},
