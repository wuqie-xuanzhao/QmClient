...
TEST(QmFontIconsContract, FontIndexKeepsIconFacesInSyncWithCodepoints)
{
	...
	EXPECT_FALSE(ReadTestSourceFile("data/qmclient/fonts/Phosphor-Regular.ttf").empty());
	EXPECT_FALSE(ReadTestSourceFile("data/qmclient/fonts/Phosphor-Bold.ttf").empty());
}
