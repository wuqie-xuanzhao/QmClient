...
def main():
    ...
    if gen_client_content_header or gen_server_content_header:
        ...
        EmitEnum(
            [
                f"ANIM_{i.name.value.upper()}"
                for i in content.container.animations.items
            ],
            "NUM_ANIMS",
        )
        EmitEnum(
    ...
    if gen_network_header:
        ...
        for line in create_enum_table(
            ["NETOBJ_INVALID"] + [o.enum_name for o in network.Objects],
            "NUM_NETOBJTYPES",
        ):
            print(line)
        print("")
        for line in create_enum_table(
            ["NETMSG_INVALID"] + [o.enum_name for o in network.Messages],
            "NUM_NETMSGTYPES",
        ):
            print(line)
        print("")
