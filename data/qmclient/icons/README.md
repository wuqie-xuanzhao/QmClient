...
- `qm_icons_{thin,light,regular,bold,fill,duotone}_{1x,2x,4x}.png` with matching JSON manifests
- `qm_icons_{thin,light,regular,bold,fill,duotone}_msdf.png` with matching JSON manifests
...
The MTSDF files are generated directly from the Phosphor SVG sources with
